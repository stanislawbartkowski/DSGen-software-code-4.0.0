...
cross_sales as
 (select i_product_name product_name
  ...
  FROM   {{ ref('store_sales') }}
        ...
        ,{{ ref('store') }}
        ,{{ ref('customer') }}
        ,{{ ref('customer_demographics') }} cd1
        ,{{ ref('customer_demographics') }} cd2
        ,{{ ref('promotion') }}
        ,{{ ref('household_demographics') }} hd1
        ,{{ ref('household_demographics') }} hd2
        ,{{ ref('customer_address') }} ad1
        ,{{ ref('customer_address') }} ad2
        ,{{ ref('income_band') }} ib1
        ,{{ ref('income_band') }} ib2
        ,{{ ref('item') }}
