...
from
 ...
 where ss_sold_time_sk = {{ ref('time_dim') }}.t_time_sk   
     ...
     and (({{ ref('household_demographics') }}.hd_dep_count = [HOUR.1] and {{ ref('household_demographics') }}.hd_vehicle_count<=[HOUR.1]+2) or
          ({{ ref('household_demographics') }}.hd_dep_count = [HOUR.2] and {{ ref('household_demographics') }}.hd_vehicle_count<=[HOUR.2]+2) or
          ({{ ref('household_demographics') }}.hd_dep_count = [HOUR.3] and {{ ref('household_demographics') }}.hd_vehicle_count<=[HOUR.3]+2)) 
