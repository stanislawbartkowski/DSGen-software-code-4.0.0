...
-- 
 ...
 from ( select count(*) amc
       ...
       where ws_sold_time_sk = {{ ref('time_dim') }}.t_time_sk
         ...
         and {{ ref('time_dim') }}.t_hour between [HOUR_AM] and [HOUR_AM]+1
         and {{ ref('household_demographics') }}.hd_dep_count = [DEPCNT]
      ...
      ( select count(*) pmc
       ...
       where ws_sold_time_sk = {{ ref('time_dim') }}.t_time_sk
         and ws_ship_hdemo_sk = {{ ref('household_demographics') }}.hd_demo_sk
         and ws_web_page_sk = {{ ref('web_page') }}.wp_web_page_sk
         and {{ ref('time_dim') }}.t_hour between [HOUR_PM] and [HOUR_PM]+1
         and {{ ref('household_demographics') }}.hd_dep_count = [DEPCNT]
         and {{ ref('web_page') }}.wp_char_count between 5000 and 5200) pt
